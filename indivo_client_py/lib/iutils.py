...
class IUtils(OAuth):
    ...
    def _http_request(self, method, oauth_header, parameters):
        ...
        try:
            ...
            raise Exception(self.HTTP.Errors.cannot_send_request)
        except httplib.NotConnected:
            raise Exception(self.HTTP.Errors.not_connected)
    ...
    def read_xml(self, xml_string, data_loc):
        ...
        try:
            ...
            raise Exception("Expat Error: " + xml_string)
